...
//    public final static float MARKET_ACCESS = 0.1f;
    ...
    public void displayTooltipDescription(TooltipMakerAPI tooltip, PersonAPI person, boolean isActive, boolean isSimpleMode) {
        ...
        if(!isSimpleMode) {
            ...
            tooltip.addPara("%s: %s", pad, Misc.getTextColor(), "Unsteady", ba_stringhelper.getString("conscious", person.isAICore()? "ba_unsteady_ai":"ba_unsteady_person")).setHighlightColors(getColor(), Misc.getTextColor());
