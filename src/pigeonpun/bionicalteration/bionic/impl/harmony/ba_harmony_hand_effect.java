...
public class ba_harmony_hand_effect extends ba_bionicitemplugin {
    public static float SHIP_SHIELD_RAISE_MULT = 1.1f;
    static Logger log = Global.getLogger(ba_harmony_hand_effect.class);
